...
- <Rating content="Paragon Benefit" ratings={[4]}/> Free actions. Thaumaturges *love* free actions. Draw an item, strike a foe, seek in two different places. Deceptively simple, but a good mirror user will be an absolute monster with this. Just wait till level 19 when your EVs and IVs become free actions too!
